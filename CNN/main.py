...
train_images_path = "./train_images_gray"
...
with tf.variable_scope("Logits") as scope:
    ...
    train_logits = Network.inference(
...
with tf.Session(config=run_config) as sess:
    ...
    try:
        for i in np.arange(TRAIN_STEPS):
            ...
            if (i+1) % 100 == 0:
                print("After %d training steps, loss on training/testing batch is %.2f/%.2f" % (
