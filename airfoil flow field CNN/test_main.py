...
logits = Network.inference(input_tensor=features_batch, train=False, regularizer=None)
...
while True:
    with tf.Session() as sess:
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            print("After %s testing steps, loss on test batch is %.2f" % (global_step, test_loss_value))
